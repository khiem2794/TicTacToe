...
module.exports = {
  ...
  assets: {
    ...
    // './JavaScript_server/theme/bootstrap.config.js' file.
    ...
    bootstrap: {
      extension: 'js',
      include: ['./JavaScript_server/theme/bootstrap.config.js'],
      filter: function(module, regex, options, log) {
        function is_bootstrap_style(name) {
          return name.indexOf('./JavaScript_server/theme/bootstrap.config.js') >= 0;
        }
